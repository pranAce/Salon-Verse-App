...
class SupportService {
  ...
  Future<ApiResult<SupportTicketModel>> createSupportTicket(
      UserModel? currentUser, String subject, String message) async {
    ...
    return _client.request<SupportTicketModel>(
      ...
      onSuccess: (data) => SupportTicketModel.fromJson(Map<String, dynamic>.from(data)),
    );
  }

  Future<ApiResult<List<SupportTicketModel>>> getSupportTickets(UserModel? currentUser) async {
    if (currentUser == null) return const Failure("Session required.");
    ...
    return _client.request<List<SupportTicketModel>>(
      ...
      onSuccess: (data) {
        ...
        return list.map((e) => SupportTicketModel.fromJson(Map<String, dynamic>.from(e))).toList();
      },
    );
  }

  Future<ApiResult<SupportTicketModel>> replyToTicket(String ticketId, String messageText) async {
    return _client.request<SupportTicketModel>(
      "POST",
